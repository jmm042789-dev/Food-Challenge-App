...
These Terms of Service ("Terms") govern your use of Fire Feast (the "Game"), operated by J&B Forge Studios ("J&B Forge Studios," "we," "us," or "our").

By downloading, installing, accessing, or playing Fire Feast, you agree to these Terms. If you do not agree, do not use the Game.

## 2. Eligibility

You are responsible for making sure that your use of Fire Feast complies with applicable laws and the requirements of the platform through which you access the Game. If another person is responsible for your device or account access, you should review these Terms with that person before playing.

## 3. Guest Accounts

Fire Feast currently uses guest accounts. A guest account is associated with the device or installation where it was created.

You are responsible for maintaining access to your device and protecting it from unauthorized use. Fire Feast does not currently provide a way to recover a guest account on another device. If you lose access to the device, clear the Game's stored credentials, delete the account, or remove data needed to authenticate the account, the guest account and its progress may not be recoverable.

You may not transfer, sell, share, or allow another person to misuse your guest account or its credentials.

## 4. Gameplay and Online Services

Fire Feast uses online services to provide features including guest authentication, player profiles, gameplay progress, virtual balances, inventory, active-match handling, and leaderboards.
...
These items and progression are part of the Game only. They have no real-world monetary value, cannot be exchanged for cash, and are not personal property. J&B Forge Studios retains ownership of the virtual items and related Game content as part of the Fire Feast service. Your right to access or use them is limited by these Terms and the continued availability of the Game and your guest account.
...
- cheat or use unauthorized automation;
- exploit bugs or vulnerabilities;
- modify or tamper with the Game client;
- interfere with Fire Feast online services;
- impersonate another person or player;
...
J&B Forge Studios may suspend, restrict, or terminate access to Fire Feast online services when we reasonably believe it is necessary because of cheating, abuse, a security risk, harmful activity, or a violation of these Terms.

We are not required to provide a warning before taking action. Suspension or termination may result in the loss of access to a guest account, virtual items, and gameplay progress.
...
Subject to these Terms, J&B Forge Studios grants you a limited, personal, non-exclusive, non-transferable, and revocable license to install and use Fire Feast for your own lawful, non-commercial entertainment.
...
Updates, device conditions, network availability, and third-party services may affect how the Game operates. Some features or progress may depend on local device storage or access to Fire Feast online services.
...
J&B Forge Studios is not responsible for losses caused by circumstances outside our reasonable control, including device failure, loss of local guest credentials, network interruption, or third-party platform outages.
