...
export default function TournamentPanel({ tournament, progress, onEnter, onClaimReward }: Props) {
  ...
  const artwork = getFoodArtwork(tournament.entryContestId || tournament.featuredFoods[0] || "");
  return (
    <FirePanel highlighted elevated borderColor="#E9A33E" style={styles.panel}>
      <View style={styles.header}>
        <View style={styles.art}><Image source={artwork.source} resizeMode="contain" style={[styles.artImage, { transform: [{ scale: artwork.scale }] }]} /></View>
...
const styles = StyleSheet.create({
  ...
  artImage: { height: 66, width: 66 }, heading: { flex: 1, minWidth: 0 },
  ...
  featureRow: { flexDirection: "row", gap: 5, marginTop: 6 },
