...
export const SOUND_REGISTRY: Record<SoundEvent, SoundDefinition> = {
  BUTTON_PRESS: { source: TAP, priority: 1, minIntervalMs: 90 }, COUNTDOWN_TICK: { source: TAP, priority: 3, minIntervalMs: 300 }, GO: { source: START, priority: 6, duckMusicTo: 0.65, duckDurationMs: 500, minIntervalMs: 500 },
  CORRECT_BITE: { source: TAP, priority: 2, minIntervalMs: 55 }, COMBO: { source: COMBO, priority: 3, minIntervalMs: 90 }, COMBO_MILESTONE: { source: COMBO, priority: 5, duckMusicTo: 0.72, duckDurationMs: 450, minIntervalMs: 280 },
  ...
  VICTORY: { source: START, priority: 10, duckMusicTo: 0.35, duckDurationMs: 1400, minIntervalMs: 1200 }, DEFEAT: { source: START, priority: 9, duckMusicTo: 0.42, duckDurationMs: 1100, minIntervalMs: 1200 }, REWARD: { source: COMBO, priority: 5, minIntervalMs: 250 },
