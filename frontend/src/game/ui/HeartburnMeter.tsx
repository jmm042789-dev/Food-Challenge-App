...
const styles = StyleSheet.create({
  root: { backgroundColor: "rgba(9,6,7,0.96)", borderRadius: 11, borderWidth: 1, elevation: 6, minHeight: 82, overflow: "hidden", paddingHorizontal: 8, paddingVertical: 6, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.38, shadowRadius: 7, width: 116 },
  ...
  icon: { height: 17, marginRight: 4, width: 17 },
  label: { color: "#EBC38A", fontSize: 8, fontWeight: "900", letterSpacing: 0.9 },
  percent: { color: "#FFF0D8", flex: 1, fontSize: 11, fontWeight: "900", textAlign: "right" },
  track: { backgroundColor: "rgba(54,27,21,0.92)", borderColor: "rgba(255,220,158,0.16)", borderRadius: 5, borderWidth: 1, height: 9, marginTop: 4, overflow: "hidden" },
  ...
  cueSpacer: { width: 2 },
  tier: { color: "#F1C477", flex: 1, fontSize: 7.5, fontWeight: "900", letterSpacing: 0.4 },
  multiplier: { color: "#FFF0C7", fontSize: 8.5, fontWeight: "900" },
  penaltyText: { color: "#FFB45D" },
  detail: { color: "#CFA56C", fontSize: 6.5, fontWeight: "900", letterSpacing: 0.35, minHeight: 9, textAlign: "center" },
  risk: { color: "#FFD56E" },
  instruction: { color: "#FFF0D6", fontSize: 7.5, fontWeight: "900", letterSpacing: 0.4, textAlign: "center" },
