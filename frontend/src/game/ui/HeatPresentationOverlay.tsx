...
const styles = StyleSheet.create({
  ...
  warning: { alignItems: "center", alignSelf: "center", backgroundColor: "rgba(85,8,7,0.96)", borderColor: "#FF4A32", borderRadius: 12, borderWidth: 2, elevation: 12, maxWidth: "82%", paddingHorizontal: 20, paddingVertical: 10, position: "absolute", top: "27%", width: 238, zIndex: 120 },
  warningTitle: { color: "#FFF0DA", fontSize: 21, fontWeight: "900", letterSpacing: 1.2, textAlign: "center" },
  ...
  warningTime: { color: "#FFE4B3", fontSize: 8, fontWeight: "900", letterSpacing: 0.5, marginTop: 4 },
  event: { alignItems: "center", alignSelf: "center", borderRadius: 10, borderWidth: 2, elevation: 10, maxWidth: "82%", minWidth: 180, paddingHorizontal: 20, paddingVertical: 9, position: "absolute", top: "28%" },
  ...
  eventSubtitle: { color: "#FFD27A", fontSize: 9, fontWeight: "900", letterSpacing: 1.1, marginTop: 2 },
});
