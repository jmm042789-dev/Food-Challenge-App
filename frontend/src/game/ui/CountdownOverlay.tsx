...
const styles = StyleSheet.create({
  ...
  banner: { backgroundColor: "rgba(14,10,11,0.98)", borderColor: "#D88B35", borderRadius: 12, borderWidth: 2, elevation: 10, maxWidth: 390, paddingHorizontal: 22, paddingVertical: 16, position: "absolute", shadowColor: "#000", shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.38, shadowRadius: 10, width: "88%" },
  ...
  contestName: { color: "#FFF0CF", fontSize: 26, fontWeight: "900", letterSpacing: 1.1, marginTop: 4, textAlign: "center", textShadowColor: "rgba(255,118,25,0.34)", textShadowRadius: 6 },
  location: { color: "#D2A16B", fontSize: 10, fontWeight: "800", letterSpacing: 1, marginTop: 3, textAlign: "center" },
