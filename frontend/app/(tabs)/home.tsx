...
const styles = StyleSheet.create({
  ...
  featuredBody: { alignItems: "stretch", flexDirection: "row", minHeight: 174 },
  heroArtWrap: { alignItems: "center", justifyContent: "center", marginLeft: -10, width: "43%" },
  artGlow: { backgroundColor: "rgba(213,67,13,0.16)", borderRadius: 72, height: 140, position: "absolute", width: 140 },
  heroArt: { height: 166, width: 166 },
